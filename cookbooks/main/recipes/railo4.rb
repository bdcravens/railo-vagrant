...
remote_file "/tmp/railo-4.0.2.002-jars.tar.gz" do
  #source "http://www.getrailo.org/railo/remote/download/3.3.4.003/custom/all/railo-3.3.4.003-jars.tar.gz"
  source "http://www.getrailo.org/railo/remote/download/4.0.2.002/custom/all/railo-4.0.2.002-jars.tar.gz"
...
# untar it
execute "tar xvzf railo-4.0.2.002-jars.tar.gz" do
  creates "railo-4.0.2.002-jars.tar.gz"
  action :run
  user "root"
  cwd "/tmp"
end
